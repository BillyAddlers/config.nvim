...
function M.setup()
  ...
  hi('TelescopePromptPrefix',   { fg = '#a1c9ff',             bg = '#131313' })
  hi('TelescopePromptCounter',  { fg = '#c6c6c6',  bg = '#131313' })
  hi('TelescopePromptTitle',    { fg = '#131313',             bg = '#a1c9ff' })
  hi('TelescopePreviewTitle',   { fg = '#131313',             bg = '#bbc7db' })
  hi('TelescopeResultsTitle',   { fg = '#131313',             bg = '#d8bde4' })
